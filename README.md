...
### Test the API
```powershell
Invoke-RestMethod -Uri "http://localhost:8080/api/vibe" -Method POST -ContentType "application/json" -Body '{"message":"feeling anxious, need to focus"}'
```

## Status

Sprint 1 foundation complete — frontend, backend, CORS, timer, and vibe stub endpoint.
